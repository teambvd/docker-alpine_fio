...
FIO_OFFSET_INCREMENT="${FIO_OFFSET_INCREMENT:-1G}"
...
echo === Bench Summary ===
echo =====================
echo "Random R/W IOPS: $READ_IOPS_VAL/$WRITE_IOPS_VAL. BW: $READ_BW_VAL/ $WRITE_BW_VAL"
echo "Average Latency (usec) Read/Write: $READ_LATENCY_VAL/$WRITE_LATENCY_VAL"
echo "Sequential R/W: $READ_SEQ_VAL / $WRITE_SEQ_VAL"
echo "Mixed Random R/W IOPS: $RW_MIX_R_IOPS/$RW_MIX_W_IOPS"
